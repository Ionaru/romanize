...
Thank you so much for your interest in contributing to romanize!


## Asking questions, suggesting wonderful ideas or reporting bugs

You can [submit an issue️](https://github.com/Ionaru/romanize/issues) on this GitHub repository.
...
```bash
git clone https://github.com/Ionaru/romanize.git
cd romanize
```
...
1. [Create a fork of this project](https://github.com/Ionaru/romanize/fork).
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/romanize.git`.
3. Add the original repository as remote to keep it up-to-date: `git remote add upstream https://github.com/Ionaru/romanize.git`.
